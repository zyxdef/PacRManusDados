...
- `sep = ""` indica qual caracter será o separador de colunas; se for uma 
string vazia (valor padrão), então espaço, tabulação ou salto de linha serão 
delimitadores
- `dec` indica qual caracter deve ser interpretado como ponto decimal
...
- `read.fwf()` é o canivete suíço para leitura de dados de tamanho fixo

***AQUI!!!***: um exemplo de cada formato
...
***AQUI!!!***: um exemplo de uso de cada função
